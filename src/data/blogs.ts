...
# # Trainable params: ~0.1% of total! (vs 100% for full fine-tune)`,
  ...
  // ============================================================
  {
    ...
    readTime: "7 min",
    sections: [
      // ─── SECTION 1: Build Tools Landscape ───
      {
        heading: "The JavaScript Build Tool Landscape (2026)",
        content:
          "Build tools automate bundling, transpilation, minification, code-splitting, HMR, and asset optimisation. Here's every major player:\n\n| Tool | Year | Language | Key Strength |\n|------|------|----------|-------------|\n| **Webpack** | 2012 | JS | Massive ecosystem, Module Federation, battle-tested |\n| **Rollup** | 2015 | JS | Best tree-shaking, ideal for libraries |\n| **Parcel** | 2017 | JS | Zero-config, auto-detect, great for prototypes |\n| **SWC** | 2019 | Rust | 20× faster transpilation, Babel replacement |\n| **esbuild** | 2020 | Go | 10-100× faster, used inside Vite |\n| **Vite** | 2020 | JS | Instant dev server via native ESM, minimal config |\n| **Turbopack** | 2022 | Rust | Next.js integrated, claims 700× faster than Webpack |\n| **Rspack** | 2023 | Rust | Drop-in Webpack replacement, 5-10× faster |",
        diagram: `graph TD
  TOOLS["JS Build Tools"] --> GEN1["Gen 1 — JS-Based"]
  TOOLS --> GEN2["Gen 2 — Native Speed"]
  ...
  VT -->|"prod"| RL`,
      ...
      {
        heading: "Vite vs Webpack — Head-to-Head",
        content:
          "**Webpack** starts from entry points, builds a full dependency graph, runs loaders/plugins, and outputs optimised bundles. Slow to start but extremely configurable.\n\n**Vite** serves files via native ES modules in dev (no bundling), pre-bundles deps with esbuild, and uses Rollup for production. Near-instant startup.\n\n**Benchmarks** (typical React app, ~200 components):\n- **Dev cold start**: Vite ~150ms vs Webpack ~12s (80× faster)\n- **HMR update**: Vite ~50ms vs Webpack ~1.5s (30× faster)\n- **Production build**: Vite ~8s vs Webpack ~15s (2× faster)\n- **Bundle size**: Vite ~5-10% smaller (Rollup's superior tree-shaking)\n\nThe biggest difference is in **development experience** — you spend 90% of your time there.",
        comparison: {
          title: "Vite vs Webpack",
          headers: ["⚡ Vite", "📦 Webpack"],
          rows: [
            ["Dev Startup", "~150ms (native ESM)", "~10-30s (full bundle)"],
            ["HMR Speed", "~50ms", "~500ms-3s"],
            ["Configuration", "Minimal defaults", "Verbose, highly customisable"],
            ["Plugin Ecosystem", "Growing (Rollup-compatible)", "Massive (1000s of plugins)"],
            ["Module Federation", "Community plugin", "Built-in (Webpack 5)"],
            ["TypeScript", "Native via esbuild", "Via ts-loader or babel"],
            ["Legacy Browsers", "@vitejs/plugin-legacy", "Extensive (Babel + polyfills)"],
            ["Maturity", "~70k stars, since 2020", "~65k stars, 12+ years"],
          ],
        },
        diagram: `graph LR
  subgraph "Vite Dev"
  ...
  subgraph "Webpack Dev"
    W1["Source"] --> W2["Webpack Bundler"]
    W2 -->|"full bundle"| W3["Browser"]
  end`,
      },
      // ─── SECTION 3: When to Use Which ───
      {
        ...
        content:
          "**Choose Vite when:** New project, modern framework (React/Vue/Svelte), DX priority, minimal config, SPAs.\n\n**Choose Webpack when:** Large existing codebase, Module Federation for micro-frontends, highly custom builds, extensive legacy browser support, deeply integrated plugin chains.\n\n**Choose Rspack when:** You're on Webpack but want 5-10× faster builds without rewriting config.\n\n**Choose Turbopack when:** Next.js ecosystem, maximum performance with Vercel's official tooling.",
        diagram: `graph TD
  START{"Starting a project?"} -->|"New"| VITE["⚡ Use Vite"]
  START -->|"Existing Webpack"| DECIDE{"Need more speed?"}
  DECIDE -->|"Yes, keep Webpack API"| RSPACK["🔥 Rspack"]
  DECIDE -->|"Yes, using Next.js"| TURBO["🌀 Turbopack"]
  DECIDE -->|"No"| WP["📦 Stay on Webpack"]
  START -->|"Library"| ROLLUP["🎯 Rollup"]`,
      },
      // ─── SECTION 4: Migration & Verdict ───
      {
        heading: "Migrating from Webpack to Vite — Quick Guide",
        content:
          "**10-step migration:**\n1. Install Vite + framework plugin (e.g. @vitejs/plugin-react)\n2. Create vite.config.ts with just the plugin\n3. Move index.html to project root with \`<script type=\"module\" src=\"/src/main.tsx\">\`\n4. Replace require() with import, recreate aliases in vite.config.ts\n5. Vite handles CSS, JSON, images natively — remove those loaders\n6. Change process.env.REACT_APP_* to import.meta.env.VITE_*\n7. Update scripts: \"dev\": \"vite\", \"build\": \"vite build\"\n8. Test dev + production builds\n9. Remove all webpack dependencies\n10. Watch for CommonJS-only packages (configure optimizeDeps)\n\n**The Verdict:**\n**Vite is the default for new projects in 2026.** 80× faster dev startup, near-zero config, excellent framework support.\n**Webpack remains essential** for complex enterprise apps with Module Federation, custom loaders, or deeply integrated pipelines.\nPick the tool that fits your project — the best build tool is the one that gets out of your way.",
        codeSnippet: {
          language: "json",
...
// AFTER (Vite):
{
  ...
  // ============================================================
  {
    ...
    sections: [
      ...
      {
        heading: "The Hidden Tax — Developers Spend 60% of Time on Non-Coding Work",
        content:
          "Developers write code only **30-40%** of their day. The rest is code reviews, incident firefighting, ticket grooming, documentation, dependency updates, and status reports.\n\nThe 10 biggest time-wasters:\n1. **Code Reviews** — PRs wait 4-24 hrs; reviewers skim-read and miss real bugs\n2. **Incident Management** — 2-5 hrs per incident scrambling through dashboards\n3. **Ticket/Jira Grooming** — 3-5 hrs/week writing acceptance criteria and estimating\n4. **Test Writing** — Skipped 60% of the time under deadline pressure\n5. **Documentation** — Always outdated within a sprint\n6. **Dependency Updates** — Dependabot PRs pile up unreviewed\n7. **Onboarding** — 2-4 weeks per new hire reading wikis\n8. **Release Notes** — Copy-pasted from git log\n9. **Status Reports** — Same info reformatted for Slack, email, Jira\n10. **Log Analysis** — Scrolling through Kibana for hours\n\n**Agentic AI** solves this — autonomous agents that plan, use tools, observe results, and iterate without human prompting at every step.",
        diagram: `graph TD
  DEV["Developer's Day"] --> CODE["Writing Code ~37%"]
  DEV --> REVIEW["Code Reviews ~12%"]
  DEV --> MEETINGS["Meetings ~19%"]
  DEV --> TICKETS["Ticket Grooming ~6%"]
  DEV --> DEBUG["Debugging ~12%"]
  DEV --> DOCS["Documentation ~6%"]
  DEV --> CONTEXT["Context Switching ~7%"]
  ...
  style DEBUG fill:#ef4444,color:#fff`,
        comparison: {
          title: "10 Problems — Impact & Automation Potential",
          headers: ["Problem", "Time Wasted / Potential"],
          rows: [
            ["Code Reviews", "5-10 hrs/week per team", "HIGH — AI first-pass in 60 seconds"],
            ["Incident Mgmt", "2-5 hrs/incident", "HIGH — AI diagnoses + suggests fix"],
            ["Ticket Grooming", "3-5 hrs/week", "HIGH — AI writes acceptance criteria"],
            ["Test Writing", "Skipped 60%", "HIGH — AI generates + runs + fixes tests"],
            ["Documentation", "Always stale", "HIGH — AI auto-updates on every merge"],
            ["Dependencies", "2-4 hrs/week", "MEDIUM — AI reviews changelogs, runs tests"],
            ["Onboarding", "2-4 weeks/hire", "MEDIUM — AI codebase Q&A bot"],
            ["Release Notes", "1-2 hrs/release", "HIGH — AI summarises commits"],
            ["Status Reports", "2-3 hrs/week", "HIGH — AI aggregates from Jira/Git/Slack"],
            ["Log Analysis", "1-3 hrs/incident", "HIGH — AI finds root cause in seconds"],
          ],
        },
      },
      // ─── SECTION 2: Top 3 Automations Deep Dive ───
      {
        heading: "Top 3 Automations — Code Review, Incidents & Test Generation",
        content:
          "**1. AI Code Review Agent** — triggers on every PR:\n- Scans for bugs, security vulnerabilities (XSS, injection, secrets)\n- Enforces coding standards and flags missing tests\n- Generates a PR summary\n- Posts review in **60 seconds** — human reviewer focuses only on architecture\n- **Result**: Review time drops 50-70%, bug escape rate drops\n\n**2. Incident Response Agent** — triggers on alerts:\n- Queries logs, metrics, and recent deploys in parallel\n- Correlates errors with recent code changes\n- Searches past incidents for similar patterns\n- Suggests root cause with confidence score\n- If confidence > 90%, auto-fixes (rollback, restart, scale)\n- Auto-generates post-mortem draft\n- **Result**: MTTR drops from 2 hours to 15 minutes\n\n**3. Test Generation Agent** — runs on every PR:\n- Analyses changed code, identifies functions/branches/edge cases\n- Generates unit tests with mocks and assertions\n- **Runs the tests**, reads failures, fixes them, and retries (agentic loop)\n- Creates PR with passing test files\n- **Result**: Coverage jumps from 40% to 80%",
        diagram: `graph TD
  PR["PR Opened"] --> REVIEW["Review Agent: 60s"]
  REVIEW --> BUGS["Find Bugs & Security Issues"]
  REVIEW --> TESTS["Test Agent: Generate + Run + Fix"]
  TESTS --> CHECK{"Tests Pass?"}
  CHECK -->|No| FIX["Fix & Retry"]
  FIX --> CHECK
  CHECK -->|Yes| DONE["Post Results to PR"]

  ALERT["Alert Fires"] --> INCIDENT["Incident Agent"]
  INCIDENT --> LOGS["Query Logs + Metrics + Deploys"]
  LOGS --> RCA["Root Cause Analysis"]
  RCA --> CONF{"Confidence > 90%?"}
  CONF -->|Yes| AUTOFIX["Auto-fix + Notify Slack"]
  CONF -->|No| HUMAN["Notify On-call with Context"]`,
      },
      // ─── SECTION 3: Existing Tools ───
      {
        heading: "Existing Tools — No Custom Agent Needed",
        content:
          "Before building your own, here are ready-made tools for each problem:\n\n| Problem | Top Tools | Cost |\n|---------|-----------|------|\n| **Code Review** | GitHub Copilot Review, CodeRabbit, Sourcery, SonarCloud, Snyk | Free-$15/user/mo |\n| **Incidents** | PagerDuty AIOps, Datadog Watchdog, Rootly, Sentry | Free tier-Enterprise |\n| **Tickets** | Jira AI (Atlassian Intelligence), Linear, Stepsize | Free-Premium |\n| **Testing** | Qodo (CodiumAI), Diffblue Cover, Katalon, Mabl | Free tier-Enterprise |\n| **Documentation** | Mintlify, Swimm, ReadMe, TypeDoc | Free tier-$10/user/mo |\n| **Dependencies** | Dependabot, Renovate Bot, Socket.dev, Snyk | Free-Paid |\n| **Onboarding** | Swimm, GitBook, Guru, Loom | Free-Paid |\n| **Release Notes** | Release Drafter, Changesets, Semantic Release | All Free |\n| **Status Reports** | Geekbot, LinearB, Sleuth, Swarmia | Free tier-Enterprise |\n| **Log Analysis** | Datadog Watchdog, Elastic ML, Honeycomb, New Relic AI | Free tier-Enterprise |",
        comparison: {
          title: "Top Tool Picks per Problem",
          headers: ["Problem", "Best Pick"],
          rows: [
            ["Code Review", "CodeRabbit — auto-reviews every PR, learns codebase", "Free (OSS) / ~$15/user/mo"],
            ["Incidents", "PagerDuty AIOps — auto-correlates alerts, suggests root cause", "Enterprise"],
            ["Tickets", "Jira AI — auto-generates acceptance criteria, suggests related tickets", "Jira Cloud Premium"],
            ["Testing", "Qodo (CodiumAI) — generates tests with edge cases, IDE extension", "Free tier"],
            ["Docs", "Swimm — auto-detects stale docs after code changes", "Free tier"],
            ["Dependencies", "Renovate Bot — groups updates, auto-merges patches", "Free / Open-source"],
            ["Release Notes", "Semantic Release — fully automated versioning + changelog", "Free"],
          ],
        },
      },
      // ─── SECTION 4: LangGraph Code Sample ───
      {
        heading: "Build Your Own — LangGraph PR Review Workflow",
        content:
          "Here's a practical LangGraph workflow: **Review → Security Scan → Test Generation → Summary**. If critical security issues are found, it blocks the PR.",
        codeSnippet: {
          language: "python",
          code: `# Agentic PR Workflow — LangGraph
...
def review_agent(state: PRState) -> PRState:
    result = llm.invoke(f"Review for bugs, style, logic:\\n{state['pr_diff']}")
    state["review_comments"] = result.content
    return state

def security_agent(state: PRState) -> PRState:
    result = llm.invoke(f"Scan for XSS, injection, secrets:\\n{state['pr_diff']}")
    state["security_issues"] = [result.content] if "CRITICAL" in result.content else []
    return state

def test_agent(state: PRState) -> PRState:
    result = llm.invoke(f"Generate Jest tests with edge cases:\\n{state['pr_diff']}")
    state["tests_generated"] = result.content
    return state

def summary_agent(state: PRState) -> PRState:
    result = llm.invoke(f"""Summarise: Review: {state['review_comments']}
    Security: {state['security_issues']} Tests: {state['tests_generated']}""")
    state["summary"] = result.content
    return state

def should_block(state: PRState) -> str:
    return "block" if state["security_issues"] else "continue"

wf = StateGraph(PRState)
wf.add_node("review", review_agent)
wf.add_node("security", security_agent)
wf.add_node("test_gen", test_agent)
wf.add_node("summarise", summary_agent)
wf.set_entry_point("review")
wf.add_edge("review", "security")
wf.add_conditional_edges("security", should_block,
    {"block": "summarise", "continue": "test_gen"})
wf.add_edge("test_gen", "summarise")
wf.add_edge("summarise", END)

app = wf.compile()
# Trigger via GitHub webhook → post result as PR comment`,
        },
        diagram: `graph TD
  ...
  SUMMARY --> POST`,
      ...
      {
        heading: "ROI — Before vs After Agentic AI",
        content:
          "**Key metrics to track:**\n\n| Metric | Before | After | Improvement |\n|--------|--------|-------|-------------|\n| PR merge time | 24 hrs | 4 hrs | **6x faster** |\n| Code review turnaround | 8 hrs | 1 hr | **8x faster** |\n| Test coverage | 40% | 80% | **2x** |\n| MTTR (incidents) | 2 hrs | 15 min | **8x faster** |\n| Grooming meetings | 5 hrs/wk | 1 hr/wk | **5x less** |\n| Documentation freshness | Quarterly | Every merge | **Always current** |\n| New dev ramp-up | 4 weeks | 1 week | **4x faster** |\n\n**Cost:** ~$200-500/month in API calls for a team of 10.\n**Value:** 5-10 hrs/week saved per developer × $50/hr = **$2,500/mo per dev**.\n**ROI: 50x within the first month.**",
        diagram: `graph LR
  BEFORE["Before"] --> B1["PR: 24 hrs"]
  BEFORE --> B2["MTTR: 2 hrs"]
  BEFORE --> B3["Coverage: 40%"]

  AFTER["After"] --> A1["PR: 4 hrs"]
  AFTER --> A2["MTTR: 15 min"]
  AFTER --> A3["Coverage: 80%"]`,
      },
      // ─── SECTION 6: Getting Started ───
      {
        heading: "Getting Started — Your First Agent in 1 Week",
        content:
          "Start with **ONE** automation — Code Review Agent is the safest (worst case: a bad comment, not a broken deploy).\n\n**Day 1-2:** Set up Python + LangGraph + OpenAI API key + GitHub webhook.\n**Day 3-4:** Build the review agent, test on 5 recent PRs, tune the prompt.\n**Day 5:** Deploy as a serverless function (Azure Function / AWS Lambda), connect webhook, set to comment-only mode.\n**Week 2-4:** Collect team feedback, tune for precision over recall, add test generation as second workflow.\n\n**Common Mistakes to Avoid:**\n- Don't automate everything at once — start with one workflow\n- Don't skip human-in-the-loop — agents should ADVISE first, not ACT\n- Don't ignore false positives — if 50% of comments are noise, devs will ignore all of them\n- Don't forget to measure before/after — you need baselines to prove ROI\n- Don't over-engineer v1 — start with a simple chain, add complexity when it proves value\n\n**The golden rule:** Start with AI as an **advisor** (comments, suggestions), not a **gatekeeper** (blocking, auto-merging). Build trust first.\n\nThe tools exist. The frameworks are mature. The ROI is proven. Start building your first agentic workflow today.",
      },
    ],
  },
  ...
  // ── Blog 22 ─────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      {
        heading: "The Problem — Why Manual Job Search Fails",
        content: `The average job seeker spends **11 hours/week** on applications yet lands interviews from only **2-3%** of submissions. Key pain points:

• **ATS black holes** — 75% of resumes are auto-rejected before a human sees them.
• **Generic outreach** — Cold LinkedIn messages get < 5% response rates.
• **No data on offers** — Most candidates accept the first offer without market benchmarks.

**Agentic AI** changes this by deploying autonomous agents that discover jobs, tailor resumes, send smart outreach, prep you for interviews, and benchmark offers — running **24/7** on your behalf. The result: **15-25% interview rates** instead of 2-3%.`,
        diagram: `graph TD
  MANUAL["Manual Search"] --> R1["2-3% Interview Rate"]
  MANUAL --> R2["11 hrs/week effort"]

  AI["Agentic AI Search"] --> A1["15-25% Interview Rate"]
  AI --> A2["3-5 hrs/week effort"]

  AI --> S1["Auto-Discover Jobs"]
  AI --> S2["Tailor Resume per JD"]
  AI --> S3["Smart Networking"]
  AI --> S4["Interview Prep Agent"]
  AI --> S5["Offer Benchmarking"]`,
      },

      // ── 2. The 8 Automatable Stages ───────────────────────────
      {
        heading: "8 Stages of Job Search You Can Automate",
        content: `Every job search flows through these stages — AI can help at each:

| Stage | What AI Does | Top Tool |
|-------|-------------|----------|
| **1. Self-Assessment** | Analyzes resume + GitHub to find skill gaps | Jobscan, LinkedIn Skills |
| **2. Job Discovery** | Crawls 10+ boards, scores jobs against your profile | Sonara, Otta, Simplify |
| **3. Resume Tailoring** | Rewrites resume per JD with ATS keyword optimization | Teal, Rezi, ChatGPT |
| **4. Auto-Apply** | Fills forms + submits across platforms | LazyApply, LoopCV, Simplify Copilot |
| **5. Networking** | Finds hiring managers, drafts personalized outreach | Apollo.io, Hunter.io, Hirect |
| **6. Interview Prep** | Researches company, predicts questions, drafts STAR answers | InterviewGPT, Pramp, Glassdoor |
| **7. Mock Interviews** | AI interviewer with scoring and feedback | Google Interview Warmup, Yoodli |
| **8. Offer Negotiation** | Pulls comp data, drafts counter-offer scripts | Levels.fyi, Payscale, Blind |`,
        diagram: `graph LR
  S1["1. Self-Assessment"] --> S2["2. Discovery"]
  S2 --> S3["3. Resume Tailor"]
  S3 --> S4["4. Auto-Apply"]
  S4 --> S5["5. Networking"]
  S5 --> S6["6. Interview Prep"]
  S6 --> S7["7. Mock Interview"]
  S7 --> S8["8. Negotiate Offer"]`,
      },

      // ── 3. Top Tools by Category ──────────────────────────────
      {
        heading: "Best AI Job Search Tools — Quick Reference",
        content: `The top pick in each category so you can start today:

**🔍 Job Discovery**: **Sonara** ($29/mo) — fully autonomous find + apply agent. Free alternative: **Otta** + **Simplify** extension.

**📝 Resume & ATS**: **Teal** (freemium) — AI resume builder + keyword matching + job tracker. For pure ATS: **Rezi** or **Jobscan**.

**🚀 Auto-Apply**: **LazyApply** ($99/mo) — widest platform coverage (LinkedIn, Indeed, ZipRecruiter). Budget: **LoopCV** (freemium).

**🤝 Networking**: **Apollo.io** (freemium) — find emails + automate outreach drip sequences. For direct chat with hiring managers: **Hirect** (free).

**🎤 Interview Prep**: **Google Interview Warmup** (free) for practice. **Final Round AI** ($96/mo) for a real-time copilot overlay during live interviews.

**💰 Salary Data**: **Levels.fyi** (free) — most accurate total comp benchmarks for tech roles.

**🤖 End-to-End Agent**: **Auto_Jobs_Applier_AIHawk** (open-source, 22K+ GitHub stars) — AI-powered LinkedIn auto-apply with resume tailoring.

**💡 $0/month Starter Stack:**
Google Sheets (tracker) + Simplify (auto-discover) + ChatGPT Free (resume tailor) + Google Alerts (company news) + Notion Free (CRM)`,
        comparison: {
          title: "AI Job Search Tools — Best Picks by Category",
          headers: ["Category", "Best Paid"],
          rows: [
            ["Job Discovery", "Sonara ($29/mo)", "Otta + Simplify (Free)"],
            ["Resume / ATS", "Teal Pro ($9/wk)", "ChatGPT + Jobscan Free"],
            ["Auto-Apply", "LazyApply ($99/mo)", "LoopCV (Freemium)"],
            ["Networking", "Apollo.io ($49/mo)", "Hunter.io + Hirect (Free)"],
            ["Interview Prep", "Final Round AI ($96/mo)", "Google Warmup (Free)"],
            ["Salary Data", "— (all free)", "Levels.fyi + Blind (Free)"],
            ["Full Agent (OSS)", "— (self-hosted)", "AIHawk (GitHub, Free)"],
          ],
        },
      },
      ...
      {
        heading: "3 Key Agentic Workflow Patterns",
        content: `Unlike a simple ChatGPT prompt, **agentic workflows** use specialized sub-agents that collaborate autonomously:

**Pattern 1 — Daily Job Scout**
Runs on a schedule → scrapes 10+ boards → scores each job against your profile → filters duplicates → sends a ranked digest via Slack/Email.
*Stack: Playwright + OpenAI Embeddings + SendGrid*

**Pattern 2 — Application Factory**
Triggered when you approve a job → analyzes JD → tailors resume → generates cover letter → checks ATS score (target ≥ 85%) → submits.
*Stack: GPT-4o + Puppeteer + Jobscan API*

**Pattern 3 — Interview War Room**
Triggered when interview is scheduled → researches company + interviewer profiles → predicts 15-20 questions → drafts STAR answers from your experience → runs a mock session.
*Stack: Tavily Search + GPT-4o + Whisper*

**Human-in-the-Loop Checkpoints** (never skip these):
1. Approve which jobs to apply to
2. Review tailored resumes before submission
3. Approve outreach messages before sending
4. Do the actual interview yourself
5. Make the final offer decision`,
        diagram: `graph TD
  subgraph "Daily Scout"
    JS1["Scrape Boards"] --> JS2["Score & Rank"]
    JS2 --> JS3["Notify You"]
  end

  subgraph "Application Factory"
    AF1["Analyze JD"] --> AF2["Tailor Resume"]
    AF2 --> AF3["ATS Check ≥85%"]
    AF3 --> AF4["Submit"]
  end

  subgraph "Interview War Room"
    IW1["Research Company"] --> IW2["Predict Questions"]
    IW2 --> IW3["Draft STAR Answers"]
    IW3 --> IW4["Mock Interview"]
  end`,
      },

      // ── 5. Build Your Own — LangGraph Code ────────────────────
      {
        heading: "Build Your Own Job Search Agent — LangGraph Code",
        content: `Here's a simplified but functional LangGraph agent with three nodes: **discover → score → apply**.

**Architecture**: LangGraph StateGraph | GPT-4o | Playwright for scraping | Embeddings for matching`,
...
def scrape_jobs(query: str, location: str) -> list[dict]:
    """Scrape job boards for matching positions."""
    from playwright.sync_api import sync_playwright
    jobs = []
    with sync_playwright() as p:
        page = p.chromium.launch(headless=True).new_page()
        page.goto(f"https://www.linkedin.com/jobs/search/?keywords={query}&location={location}")
        for card in page.query_selector_all(".job-card-container")[:20]:
            title = card.query_selector(".job-card-list__title")
            company = card.query_selector(".job-card-container__company-name")
            if title and company:
                jobs.append({"title": title.inner_text(), "company": company.inner_text(),
                             "url": card.query_selector("a").get_attribute("href")})
    return jobs

def discover(state: JobSearchState) -> JobSearchState:
    state["discovered_jobs"] = scrape_jobs.invoke(
        {"query": state["target_role"], "location": "Remote"})
    return state

def score(state: JobSearchState) -> JobSearchState:
    emb = OpenAIEmbeddings()
    profile = emb.embed_query(f"{state['target_role']}: {', '.join(state['skills'])}")
    scored = []
    for job in state["discovered_jobs"]:
        vec = emb.embed_query(f"{job['title']} at {job['company']}")
        job["match"] = round(dot(profile, vec) / (norm(profile) * norm(vec)) * 100, 1)
        scored.append(job)
    state["scored_jobs"] = sorted(scored, key=lambda j: j["match"], reverse=True)
    return state

def apply(state: JobSearchState) -> JobSearchState:
    llm = ChatOpenAI(model="gpt-4o", temperature=0.3)
    for job in [j for j in state["scored_jobs"] if j["match"] >= 75][:5]:
        tailored = llm.invoke([{"role": "user",
            "content": f"Tailor this resume for {job['title']}:\\n{state['resume_text']}"}])
        state["applications_sent"].append({"url": job["url"], "status": "submitted"})
    return state

def route(state: JobSearchState) -> Literal["apply", "done"]:
    return "apply" if any(j["match"] >= 75 for j in state["scored_jobs"]) else "done"

# Build graph: discover → score → (apply | done)
wf = StateGraph(JobSearchState)
wf.add_node("discover", discover)
wf.add_node("score", score)
wf.add_node("apply", apply)
wf.set_entry_point("discover")
wf.add_edge("discover", "score")
wf.add_conditional_edges("score", route, {"apply": "apply", "done": END})
wf.add_edge("apply", END)

agent = wf.compile()
result = agent.invoke({
    "target_role": "Senior Full Stack Developer",
    "skills": ["React", "TypeScript", "Node.js", "Python", "AWS"],
    "resume_text": "Your master resume...",
    "discovered_jobs": [], "scored_jobs": [], "applications_sent": []
})
print(f"Applied to {len(result['applications_sent'])} jobs!")`},
      ...
      {
        heading: "No-Code Alternatives — Automate Without Coding",
        content: `You don't need to write code. These platforms let you build job search automation visually:

| Platform | How It Works | Cost |
|----------|-------------|------|
| **Zapier + ChatGPT** | Job alert → AI scores JD → adds to Google Sheet → drafts cover letter | ~$20/mo |
| **Make.com + Claude** | Visual pipelines with branching — LinkedIn → Claude → Sheets → Gmail | ~$16/mo |
| **n8n** (self-hosted) | Open-source, host free on Oracle Cloud VM — full control | $0 (API costs only) |
| **Bardeen.ai** | Browser automation, pre-built playbooks for LinkedIn → Sheets | Free tier |
| **Notion AI** | Job search CRM + AI summaries + pipeline automations | Free tier |

**The $0/month Starter Stack:**
1. Google Sheets — job tracker
2. Simplify Chrome Extension — auto-discover jobs
3. ChatGPT Free — resume + cover letter tailoring
4. Google Alerts — company news monitoring
5. Notion Free — interview prep CRM`,
      },

      // ── 7. Metrics & ROI ──────────────────────────────────────
      {
        heading: "Metrics — Manual vs. AI-Powered Job Search",
        content: `Here's what changes when you add AI to your job search:

| Metric | Manual | With AI | Improvement |
|--------|--------|---------|-------------|
| Jobs discovered/week | 20-30 | 200-500 | **10-15x** |
| Applications/week | 10-15 | 50-100 | **5-7x** |
| Interview rate | 2-3% | 12-18% | **5-6x** |
| Time per application | 30-45 min | 5-8 min | **5-6x** |
| Outreach response rate | 3-5% | 20-35% | **5-7x** |
| Time to offer | 12-20 weeks | 4-8 weeks | **2-3x** |
| Total hours/week | 15-25 | 3-5 | **5x** |

**Cost**: ~$125-210/month for a mid-tier tool stack.
**Value**: 80+ hours saved/month, 1-3 months faster placement, $5-20K better offers.
**ROI: 20-100x on tool investment.**`,
        diagram: `graph LR
  D["500 Discovered"] -->|"20%"| A["100 Applied"]
  A -->|"15%"| PS["15 Phone Screens"]
  PS -->|"53%"| I["8 Interviews"]
  I -->|"38%"| O["3 Offers"]
  O --> ACC["1 Accepted"]`,
      },
      ...
      {
        heading: "Ethical Guardrails — What to Automate vs. What NOT To",
        content: `**✅ Safe to Automate:** Job discovery, resume keyword optimization, ATS checking, company research, salary benchmarking, application tracking.

**⚠️ Automate With Human Review:** Cover letters, outreach messages, application submission, follow-up emails.

**🚫 Never Automate:**
- **Live interviews** — AI copilots are being detected; getting caught = instant rejection.
- **Take-home assignments** — You'll fail the follow-up discussion.
- **References** — Never let AI impersonate you or your references.
- **Credentials** — Never fabricate experience or education.

**🔒 Privacy Rules:**
- Don't paste your employer's proprietary code into AI tools.
- Store API keys in env variables, never in code.
- Always review AI output for hallucinations (fake companies, wrong names).

**The Golden Rule:** Use AI to **amplify your real self** — present your genuine skills more effectively, don't fabricate qualifications you don't have.`,
      },
    ],
  },
];
